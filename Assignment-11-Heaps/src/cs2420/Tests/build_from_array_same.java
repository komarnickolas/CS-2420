 ...
 * Nickolas Komarnitsky
 */
public class build_from_array_same extends Test {
    public  build_from_array_same() throws IOException {
        super();
        setWriter("Build From Array Same.txt");
        println("Size;Time");
        this.updateTitle("build_from_array_same");
    }
    @Override
