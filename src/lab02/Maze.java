...
public class Maze {
	...
	Chain chain = new Chain(); // chain can be constructed with a default constructor
	...
	/**
	 * Try to find the infinite loops! Delete the loops that are infinite.
	 */
