...
/**
 * @author Nickoals Komarnitsky and Jessica Murdock
 *
...
public class Quick_Sort_Naive<Type extends Comparable<? super Type>> extends Quick_Sort<Type>
{
	...
	{
		return "Quick Sort Naive (Cutoff: " + super.cutoff + ")"; // + super class insertion cutoff level + ")";
	}
